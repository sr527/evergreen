...
func (uis *UIServer) NewRouter() (*mux.Router, error) {
	...
	r.HandleFunc("/project/{project_id}", uis.requireAdmin(uis.loadCtx(uis.projectPage))).Methods("GET")
	r.HandleFunc("/project/{project_id}", uis.requireAdmin(uis.loadCtx(uis.modifyProject))).Methods("POST")
	r.HandleFunc("/project/{project_id}", uis.requireAdmin(uis.loadCtx(uis.addProject))).Methods("PUT")
	r.HandleFunc("/project/{project_id}/repo_revision", uis.requireAdmin(uis.loadCtx(uis.setRevision))).Methods("PUT")
